...
function Detail() {
    ...
    return (
        ...
        <div className="flex justify-start mt-3 w-[1400px] overflow-x-scroll ">
            <div className="flex ">
            <TableApplicants /> 
            <div className=" w-[1200px] mt-[5px]  rounded-lg  bg-[#295197]">
          
          <table className="min-w-full  bg-white border ">
              <thead>
                  <tr className="bg-[#E8EEF8] mt-2 rounded-lg border-[1px] border-solid border-white h-[43px] bo">
                      <th className="px-1 py-1 font-noto border-[1px] border-solid border-white  text-center w-[70px] text-[14px] font-noto font-medium text-[#22385F] ">Şəhər adı:</th>
                      <th className="px-1 py-1 font-noto  border-[1px] border-solid border-white text-center w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">Şirkətin adı:</th>
                      <th className="px-1 py-1 font-noto border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">HR mütəxəsssis:</th>
                      <th className="px-1 py-1 font-noto  border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">Vəzifə:</th>
                      <th className="px-1 py-1 font-noto border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]"> Müraciət mənbəyi:</th>
                      <th className="px-1 py-1  font-noto border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">Faktiki Bitmə</th>
                      <th className="px-1 py-1 font-noto  border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">Faktiki Bitmə</th>
                      <th className="px-1 py-1 font-noto border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">Faktiki Bitmə</th>
                      <th className="px-1 py-1  font-noto border-[1px] border-solid border-white text-center  w-[70px] text-[14px] font-medium  font-noto text-[#22385F]">Faktiki Bitmə</th>
                  </tr>
              ...
              <tbody>
                  {detailsData.map((item) => (
                      <tr key={item.id} className="border-b border-[#DFE0E2]   border-[1px] border-solid bg-white">
